...
# 配置路径与阈值
DARK_CSV_PATH = "/data/zm/Moshaboli/new_data/other_data/mask (2).csv"  # 替换为你的暗场数据路径
SAVE_MASK_PATH = "/data/zm/Moshaboli/new_data/other_data/hot_pixel_mask.npy"
FREQ_THRESHOLD = 5  # 频率阈值：大于 10 Hz 认定为固定坏点
